...
const map = {
  ...
  [JSON.stringify('gigawatt')]: { factor: 1e9, unit: 'W' },
  [JSON.stringify('gigawatts')]: { factor: 1e9, unit: 'W' },
  ...
  [JSON.stringify('kilowatts')]: { factor: 1e3, unit: 'W' },
  ...
  [JSON.stringify('megawatts')]: { factor: 1e6, unit: 'W' },
